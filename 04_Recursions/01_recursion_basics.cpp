...
// when the program reaches the line 37, the function then calls the void function and program reaches there.
...
// the completion of a function is said to be done after the last line of that fucntion is executed, but in case of recursion, the function call is not completed fully,  at the line 30 , the inner function calls itself again & again.

// the first function call when reaches line 23, makes another call to itself. ie- the first call is not completed. so it waits in the memory (stack space)
